...
// `isFalseRefusal` and its regex live in `refusal-detector.ts` — a
// dependency-free module so the single most safety-critical check in this
// file can be unit-tested directly (see `refusal-detector.test.ts`).
